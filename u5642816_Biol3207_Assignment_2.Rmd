...
ggplot(lnrr, aes(x=Year..online., y=yi, size=1/sqrt(vi))) + geom_point(alpha=0.5) + geom_smooth(method = "lm", show.legend = F) + labs(size="Inverse Sampling Variance") + ylab("Effect Size") + xlab("Year Published")
```
